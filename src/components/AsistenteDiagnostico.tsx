...
export function AsistenteDiagnostico({
  porcentaje,
  brechas,
  contexto,
}: {
  ...
  return (
    <ChatPanel
      ...
      onEnviar={(historial: MensajeChat[]) =>
        responderDiagnostico(historial, {
          porcentaje,
          brechas,
          sector: contexto?.sector ?? null,
          tamano: contexto?.tamano ?? null,
        })
      }
    />
  );
